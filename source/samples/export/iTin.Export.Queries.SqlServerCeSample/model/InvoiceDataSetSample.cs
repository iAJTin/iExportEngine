...
{
    public class InvoiceDataSetSample
    {
        private const string InvoiceQueryHeader = " 3 - Invoice query from dataset";
        ...
        public static void RunSample()
        {
            ...
            using (var cnn = new Connection { ConnectionString = Properties.Settings.Default.ChinookDatabaseConnectionString })
            {
                ...
                var export = new DataSetInput(resultDataSet);
                ...
                export.Export(ExportSettings.ImportFrom(configuration, "dataset-xlsx"));
            }
        }
                    ...
                    Resources =
                        {
                            ...
                            Lines =
                            {
                                new TextLineModel { Key = "ReportTitleLine", Style = "ReportTitleStyle", Items = { new TextModel { Merge = 13, Value = "Invoice query sample" } } },
                            ...
                            new ExportModel
                                {
                                    ...
                                    Table = new TableModel
                                    {
                                        ...
                                        Output = { Path = @"~\output\dataset", File = "InvoiceQuerySampleFromCode" },
