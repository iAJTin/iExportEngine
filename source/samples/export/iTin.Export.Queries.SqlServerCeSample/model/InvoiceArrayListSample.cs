...
{
    public class InvoiceArrayListSample
    {
        private const string InvoiceQueryHeader = " 2 - Invoice query from arraylist";
        ...
        public static void RunSample()
        {
            ...
            using (var cnn = new Connection { ConnectionString = Properties.Settings.Default.ChinookDatabaseConnectionString })
            {
                ...
                var export = new ArrayListInput<Invoice>(array, "Invoice");
                ...
                export.Export(ExportSettings.ImportFrom(configuration, "arraylist-xlsx"));
            }
        }
                            ...
                            new ExportModel
                                {
                                    ...
                                    Table = new TableModel
                                    {
                                        ...
                                        Output = { Path = @"~\output\arraylist", File = "InvoiceQuerySampleFromCode" },
