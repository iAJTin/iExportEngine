...
namespace iTinExportEngineSamples.Writers.Native
{
    public class SpreadsheetSample01
    {
        ...
        public static void RunFromConfigurationFileSample()
        {
            ...
            var configuration = new Uri(Settings.Default.SpreadsheetSample01Configuration, UriKind.Relative);
