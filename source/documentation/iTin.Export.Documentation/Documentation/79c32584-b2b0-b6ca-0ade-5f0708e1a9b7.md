...
\[Missing <summary> documentation for "M:iTin.Export.Model.BaseModel`1.ToString"\]
...
#### Return Value
Type: String<br />\[Missing <returns> documentation for "M:iTin.Export.Model.BaseModel`1.ToString"\]
