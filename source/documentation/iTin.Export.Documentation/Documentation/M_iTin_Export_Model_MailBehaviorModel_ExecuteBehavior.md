# MailBehaviorModel.ExecuteBehavior Method 
...
## Exceptions
&nbsp;<table><tr><th>Exception</th><th>Condition</th></tr><tr><td>MissingPageAsyncAttributeException</td><td>Throw if web page not is async.</td></tr></table>
