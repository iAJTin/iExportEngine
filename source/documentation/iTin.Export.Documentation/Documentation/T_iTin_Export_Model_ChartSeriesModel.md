...
\[Missing <summary> documentation for "T:iTin.Export.Model.ChartSeriesModel"\]


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;<a href="T_iTin_Export_Model_BaseModel_1">iTin.Export.Model.BaseModel</a>(<a href="T_iTin_Export_Model_BaseSimpleModelCollection_2">BaseSimpleModelCollection</a>(<a href="T_iTin_Export_Model_ChartSerieModel">ChartSerieModel</a>, <a href="T_iTin_Export_Model_ChartPlotModel">ChartPlotModel</a>))<br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_iTin_Export_Model_BaseSimpleModelCollection_2">iTin.Export.Model.BaseSimpleModelCollection</a>(<a href="T_iTin_Export_Model_ChartSerieModel">ChartSerieModel</a>, <a href="T_iTin_Export_Model_ChartPlotModel">ChartPlotModel</a>)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;iTin.Export.Model.ChartSeriesModel<br />
...
public class ChartSeriesModel : BaseSimpleModelCollection<ChartSerieModel, ChartPlotModel>
```
...
Public Class ChartSeriesModel
	Inherits BaseSimpleModelCollection(Of ChartSerieModel, ChartPlotModel)
```

The ChartSeriesModel type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_iTin_Export_Model_ChartSeriesModel__ctor">ChartSeriesModel</a></td><td>
Initializes a new instance of the ChartSeriesModel class.</td></tr></table>&nbsp;
<a href="#chartseriesmodel-class">Back to Top</a>
...
Serializes current BaseModel object into an Xml document.
 (Inherited from <a href="T_iTin_Export_Model_BaseModel_1">BaseModel(T)</a>.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_iTin_Export_Model_ChartSeriesModel_SetOwner">SetOwner</a></td><td> (Overrides <a href="M_iTin_Export_Model_BaseSimpleModelCollection_2_SetOwner">BaseSimpleModelCollection(TItem, TParent).SetOwner(TItem)</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_iTin_Export_Model_BaseModel_1_ToString">ToString</a></td><td>
Returns a string that represents the current object.
 (Inherited from <a href="T_iTin_Export_Model_BaseModel_1">BaseModel(T)</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_iTin_Export_Model_ChartSeriesModel_Validate">Validate</a></td><td>
Validates serie definition list.</td></tr></table>&nbsp;
<a href="#chartseriesmodel-class">Back to Top</a>

## Remarks
\[Missing <remarks> documentation for "T:iTin.Export.Model.ChartSeriesModel"\]
