...
**C#**<br />
``` C#
public static void WriteXsltEndWhen(
...
``` VB
<ExtensionAttribute>
Public Shared Sub WriteXsltEndWhen ( 
	writer As XmlWriter
)
```
...
## Remarks
\[Missing <remarks> documentation for "M:iTin.Export.Model.XsltExtensions.WriteXsltEndWhen(System.Xml.XmlWriter)"\]
