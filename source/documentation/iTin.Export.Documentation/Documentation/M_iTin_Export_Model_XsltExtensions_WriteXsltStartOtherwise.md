...
**C#**<br />
``` C#
public static void WriteXsltStartOtherwise(
...
``` VB
<ExtensionAttribute>
Public Shared Sub WriteXsltStartOtherwise ( 
	writer As XmlWriter
)
```
...
## Remarks
\[Missing <remarks> documentation for "M:iTin.Export.Model.XsltExtensions.WriteXsltStartOtherwise(System.Xml.XmlWriter)"\]
