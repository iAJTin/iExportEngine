...
\[Missing <summary> documentation for "T:iTin.Export.Model.CoordenatesModel"\]\[Missing <include> target documentation in 'T:iTin.Export.Model.CoordenatesModel'.  File: '..\..\iTin.Export.Documentation.xml' Path: 'Model/Coordenates/Class[@name="info"]/*'\]
...
## Remarks
\[Missing <remarks> documentation for "T:iTin.Export.Model.CoordenatesModel"\]
