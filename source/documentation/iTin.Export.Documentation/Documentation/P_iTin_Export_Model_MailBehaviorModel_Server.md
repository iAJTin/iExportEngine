...
#### Property Value
Type: <a href="T_iTin_Export_Model_MailServerModel">MailServerModel</a><br />Reference to mail server configuration, contains collection for mail server credentials.
