...
\[Missing <summary> documentation for "T:iTin.Export.Model.ColumnHeadersModel"\]


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;<a href="T_iTin_Export_Model_BaseModel_1">iTin.Export.Model.BaseModel</a>(<a href="T_iTin_Export_Model_BaseSimpleModelCollection_2">BaseSimpleModelCollection</a>(<a href="T_iTin_Export_Model_ColumnHeaderModel">ColumnHeaderModel</a>, <a href="T_iTin_Export_Model_TableModel">TableModel</a>))<br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_iTin_Export_Model_BaseSimpleModelCollection_2">iTin.Export.Model.BaseSimpleModelCollection</a>(<a href="T_iTin_Export_Model_ColumnHeaderModel">ColumnHeaderModel</a>, <a href="T_iTin_Export_Model_TableModel">TableModel</a>)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_iTin_Export_Model_BaseComplexModelCollection_3">iTin.Export.Model.BaseComplexModelCollection</a>(<a href="T_iTin_Export_Model_ColumnHeaderModel">ColumnHeaderModel</a>, <a href="T_iTin_Export_Model_TableModel">TableModel</a>, String)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;iTin.Export.Model.ColumnHeadersModel<br />
...
public class ColumnHeadersModel : BaseComplexModelCollection<ColumnHeaderModel, TableModel, string>
```
...
Public Class ColumnHeadersModel
	Inherits BaseComplexModelCollection(Of ColumnHeaderModel, TableModel, String)
```

The ColumnHeadersModel type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_iTin_Export_Model_ColumnHeadersModel__ctor">ColumnHeadersModel</a></td><td>
Initializes a new instance of the ColumnHeadersModel class</td></tr></table>&nbsp;
<a href="#columnheadersmodel-class">Back to Top</a>
...
Searches for an element that matches the conditions defined by the specified predicate, and returns the first occurrence within the entire <a href="T_iTin_Export_Model_BaseSimpleModelCollection_2">BaseSimpleModelCollection(TItem, TParent)</a>.
 (Inherited from <a href="T_iTin_Export_Model_BaseSimpleModelCollection_2">BaseSimpleModelCollection(TItem, TParent)</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_iTin_Export_Model_ColumnHeadersModel_GetBy">GetBy</a></td><td>
...
Serializes current BaseModel object into an Xml document.
 (Inherited from <a href="T_iTin_Export_Model_BaseModel_1">BaseModel(T)</a>.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_iTin_Export_Model_ColumnHeadersModel_SetOwner">SetOwner</a></td><td>
...
## Remarks
\[Missing <remarks> documentation for "T:iTin.Export.Model.ColumnHeadersModel"\]
