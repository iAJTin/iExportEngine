...
**C#**<br />
``` C#
public static void WriteXsltEndOtherwise(
...
``` VB
<ExtensionAttribute>
Public Shared Sub WriteXsltEndOtherwise ( 
	writer As XmlWriter
)
```
...
## Remarks
\[Missing <remarks> documentation for "M:iTin.Export.Model.XsltExtensions.WriteXsltEndOtherwise(System.Xml.XmlWriter)"\]
