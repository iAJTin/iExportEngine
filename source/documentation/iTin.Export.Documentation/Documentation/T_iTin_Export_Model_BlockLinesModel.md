...
A Specialization of BaseSimpleModelCollection(TItem, TParent) class.<br />. Which acts as the base class for nodes of model which are of collection type \[Missing <include> target documentation in 'T:iTin.Export.Model.BlockLinesModel'.  File: '..\..\iTin.Export.Documentation.xml' Path: 'Model/Table/Class[@name='info']/*'\]


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;<a href="T_iTin_Export_Model_BaseModel_1">iTin.Export.Model.BaseModel</a>(<a href="T_iTin_Export_Model_BaseSimpleModelCollection_2">BaseSimpleModelCollection</a>(<a href="T_iTin_Export_Model_BlockLineModel">BlockLineModel</a>, <a href="T_iTin_Export_Model_ExportModel">ExportModel</a>))<br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_iTin_Export_Model_BaseSimpleModelCollection_2">iTin.Export.Model.BaseSimpleModelCollection</a>(<a href="T_iTin_Export_Model_BlockLineModel">BlockLineModel</a>, <a href="T_iTin_Export_Model_ExportModel">ExportModel</a>)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_iTin_Export_Model_BaseComplexModelCollection_3">iTin.Export.Model.BaseComplexModelCollection</a>(<a href="T_iTin_Export_Model_BlockLineModel">BlockLineModel</a>, <a href="T_iTin_Export_Model_ExportModel">ExportModel</a>, String)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;iTin.Export.Model.BlockLinesModel<br />
...
public class BlockLinesModel : BaseComplexModelCollection<BlockLineModel, ExportModel, string>
```

**VB**<br />
``` VB
<SerializableAttribute>
Public Class BlockLinesModel
	Inherits BaseComplexModelCollection(Of BlockLineModel, ExportModel, String)
```

The BlockLinesModel type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_iTin_Export_Model_BlockLinesModel__ctor">BlockLinesModel</a></td><td>
Initializes a new instance of the BlockLinesModel class</td></tr></table>&nbsp;
<a href="#blocklinesmodel-class">Back to Top</a>
...
Searches for an element that matches the conditions defined by the specified predicate, and returns the first occurrence within the entire <a href="T_iTin_Export_Model_BaseSimpleModelCollection_2">BaseSimpleModelCollection(TItem, TParent)</a>.
 (Inherited from <a href="T_iTin_Export_Model_BaseSimpleModelCollection_2">BaseSimpleModelCollection(TItem, TParent)</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_iTin_Export_Model_BlockLinesModel_GetBy">GetBy</a></td><td> (Overrides <a href="M_iTin_Export_Model_BaseComplexModelCollection_3_GetBy">BaseComplexModelCollection(TItem, TParent, TSearch).GetBy(TSearch)</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_iTin_Export_Model_BaseSimpleModelCollection_2_GetEnumerator">GetEnumerator</a></td><td>
