...
\[Missing <summary> documentation for "T:iTin.Export.Model.StylesModel"\]\[Missing <include> target documentation in 'T:iTin.Export.Model.StylesModel'.  File: '..\..\iTin.Export.Documentation.xml' Path: 'Model/Styles/Class[@name='info']/*'\]
...
## Remarks
\[Missing <remarks> documentation for "T:iTin.Export.Model.StylesModel"\]
