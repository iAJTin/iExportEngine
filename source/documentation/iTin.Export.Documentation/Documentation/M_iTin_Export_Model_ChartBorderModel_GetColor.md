# ChartBorderModel.GetColor Method 
Additional header content 

Gets a reference to the Color structure that represents color for this border.
...
#### Return Value
Type: Color<br />A Color structure that represents color for this border.
