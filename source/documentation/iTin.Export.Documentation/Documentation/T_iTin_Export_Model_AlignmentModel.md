...
Base class for model elements. Implements functionality to record and read configuration files. \[Missing <include> target documentation in 'T:iTin.Export.Model.AlignmentModel'.  File: '..\..\iTin.Export.Documentation.xml' Path: 'Model/Alignment/Class[@name='info']/*'\]
