...
\[Missing <summary> documentation for "T:iTin.Export.ComponentModel.Patterns.OrNotSpecification`1"\]


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;<a href="T_iTin_Export_ComponentModel_Patterns_CompositeSpecification_1">iTin.Export.ComponentModel.Patterns.CompositeSpecification</a>(*T*)<br />&nbsp;&nbsp;&nbsp;&nbsp;iTin.Export.ComponentModel.Patterns.OrNotSpecification(T)<br />
...
**VB**<br />
``` VB
Public Class OrNotSpecification(Of T)
	Inherits CompositeSpecification(Of T)
```


#### Type Parameters
&nbsp;<dl><dt>T</dt><dd>\[Missing <typeparam name="T"/> documentation for "T:iTin.Export.ComponentModel.Patterns.OrNotSpecification`1"\]</dd></dl>&nbsp;
The OrNotSpecification(T) type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_iTin_Export_ComponentModel_Patterns_OrNotSpecification_1__ctor">OrNotSpecification(T)</a></td><td>
Initializes a new instance of the OrNotSpecification(T) class</td></tr></table>&nbsp;
<a href="#ornotspecification(*t*)-class">Back to Top</a>
...
## Remarks
\[Missing <remarks> documentation for "T:iTin.Export.ComponentModel.Patterns.OrNotSpecification`1"\]
