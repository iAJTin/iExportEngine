...
Base class for model elements. Implements functionality to record and read configuration files. \[Missing <include> target documentation in 'T:iTin.Export.Model.BlockLineModel'.  File: '..\..\iTin.Export.Documentation.xml' Path: 'Model/Table/Class[@name='info']/*'\]
...
## Remarks
\[Missing <remarks> documentation for "T:iTin.Export.Model.BlockLineModel"\]
