...
public class MiniChartColumnPointsModel : BaseMiniChartPointsModel
```

**VB**<br />
``` VB
<SerializableAttribute>
Public Class MiniChartColumnPointsModel
	Inherits BaseMiniChartPointsModel
```

The MiniChartColumnPointsModel type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_iTin_Export_Model_MiniChartColumnPointsModel__ctor">MiniChartColumnPointsModel</a></td><td>
Initializes a new instance of the MiniChartColumnPointsModel class</td></tr></table>&nbsp;
<a href="#minichartcolumnpointsmodel-class">Back to Top</a>
...
## Remarks
\[Missing <remarks> documentation for "T:iTin.Export.Model.MiniChartColumnPointsModel"\]
