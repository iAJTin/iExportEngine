    ...
    static class ChartXmlExtensions
    {
        #region Public Static Methods
            ...
            public static void AddAxisGridLinesMode(this XmlNode axis, KnownPlotGridLine model)
            {
                ...
                XmlNode majorGridLinesElement;
                var existMajorGridLinesNode = ChartXmlHelper.TryGetElementFrom(axis, "c:majorGridlines", out majorGridLinesElement);
                ...
                XmlNode minorGridLinesElement;
                var existMinorGridLinesNode = ChartXmlHelper.TryGetElementFrom(axis, "c:minorGridlines", out minorGridLinesElement);
