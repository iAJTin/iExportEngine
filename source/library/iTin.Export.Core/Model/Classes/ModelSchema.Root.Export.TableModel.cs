    ...
    public partial class TableModel
    {
        ...
        #region public properties
            ...
            public ColumnHeadersModel Headers
            {
                get
                {
                    return headers ?? (headers = new ColumnHeadersModel(this));
                }
                set
                {
                    headers = value;
            ...
            public FieldsModel Fields
            {
                get
                {
                    return fields ?? (fields = new FieldsModel(this));
                }
                set
                {
                    fields = value;
            ...
            public ChartsModel Charts
            {
                get
                {
                    return charts ?? (charts = new ChartsModel(this));
                }
                set
                {
                    charts = value;
        ...
        #region public methods
            ...
            public IEnumerable<KeyValuePair<BaseDataFieldModel, Size>> GetHeaderColumnsSize(IAdapter adapter)
            {
                ...
                foreach (DataFieldModel fld in flds)
                {
        ...
        #region public override methods
            ...
            {
                return string.Format("Name=\"{0}\", Type={1}", Name, Exporter.ExporterType);
            }
            #endregion
