    ...
    public partial class ExportModel
    {
        ...
        #region public properties
            ...
            public string Name
            {
                get
                {
                    return GetValueByReflection(this, name);
                }
                set
                {
            ...
            public BlockLinesModel BlockLines
            {
                get
                {
                    return lines ?? (lines = new BlockLinesModel(this));
                }
                set
                {
                    lines = value;
