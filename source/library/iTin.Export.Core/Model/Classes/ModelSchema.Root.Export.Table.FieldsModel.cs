...
namespace iTin.Export.Model
{
    ...
    public partial class FieldsModel
    {
        ...
        #region Public Methods
            ...
            {
                Dictionary<BaseDataFieldModel, List<string>> fieldErrorDictionary;
                var hasFieldErrors = HasFieldErrors(this, out fieldErrorDictionary);
                ...
                Dictionary<BaseDataFieldModel, List<string>> fieldStyleErrorDictionary;
                var hasFieldStyleErrors = HasStyleErrors(this, out fieldStyleErrorDictionary);
