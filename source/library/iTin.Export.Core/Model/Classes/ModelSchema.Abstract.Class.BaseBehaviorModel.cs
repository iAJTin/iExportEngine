...
namespace iTin.Export.Model
{
    ...
    ///       <item><description>Implement the method <see cref="iTin.Export.Model.BaseBehaviorModel.ExecuteBehavior"/>.</description></item>
    ...
    public partial class BaseBehaviorModel : IBehavior
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private YesNo canExecute;

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private BehaviorsModel owner;
        #endregion
        ...
        #region public override properties
            ...
            public override bool IsDefault
            {
                get
                {
                    ...
                    return
                        base.IsDefault &&
                        CanExecute.Equals(DefaultExecute);
                }
            }
            #endregion
