    ...
    public partial class CoordenatesModel : ICloneable
    {
        ...
        #region public properties
            ...
            public int[] Coordenates
            {
                get
                {
                    return _coordenates ?? (_coordenates = DefaultCoordenates);
                }
                set
                {
                    if (value != null)
            ...
            public Point TableCoordenates
            {
                get { return new Point(Coordenates[0], Coordenates[1]); }
            }
            #endregion
        ...
        #region public override properties
            ...
            public override bool IsDefault
            {
                get
                {
                    return Coordenates.SequenceEqual(DefaultCoordenates);
                }
            }
        #endregion
