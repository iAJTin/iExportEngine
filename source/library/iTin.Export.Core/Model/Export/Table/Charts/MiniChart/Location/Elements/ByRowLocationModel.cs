...
namespace iTin.Export.Model
{
    ...
    public partial class ByRowLocationModel : ICloneable
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private const KnownMiniChartLocation DefaultLocation = KnownMiniChartLocation.Right;
        #endregion
        ...
        #region [public] ByRowLocationModel(): Initializes a new instance of this class
        public ByRowLocationModel()
        {
        ...
        public ByRowLocationModel Clone()
        {
            var clonned = (ByRowLocationModel) MemberwiseClone();
