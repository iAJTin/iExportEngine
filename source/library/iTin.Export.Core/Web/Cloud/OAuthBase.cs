...
namespace iTin.Export.Web.Cloud
{
    /// <summary>
    /// <strong><c>OAuth</c></strong> .NET library from google. <a href="http://oauth.googlecode.com/svn/code/csharp/OAuthBase.cs">http://oauth.googlecode.com/svn/code/csharp/OAuthBase.cs</a>.
    /// </summary>
    class OAuthBase
    {
        /// <summary>
        ...
        /// A base64 string of the hash value
        /// </returns>
        /// <exception cref="System.NotImplementedException">RSASHA1 not implemented</exception>
            ...
            switch (signatureType) 
            {
                ...
                case SignatureTypes.HMACSHA1:
                    ...
                    var hmacsha1 = new HMACSHA1
                                            {
                                                Key = Encoding.ASCII.GetBytes(string.Format(CultureInfo.InvariantCulture, "{0}&{1}", UrlEncode(consumerSecret), string.IsNullOrEmpty(tokenSecret) ? string.Empty : UrlEncode(tokenSecret)))
                                            };
