...
namespace iTin.Export.ComponentModel.Adapters
{
    ...
    public abstract class BaseAdapter : IAdapter
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private readonly AdapterMetadata _metadataInformation;
        #endregion
        ...
        protected BaseAdapter()
        {
            ...
            _metadataInformation = new AdapterMetadata(this);
        }
        #endregion
        ...
        #region [public] (AdapterMetadata) MetadataInformation: Gets a reference that contains the metadata information about this adapter
        /// <inheritdoc />
        /// <summary>
        /// Gets a reference that contains the metadata information about this adapter.
        /// </summary>
        /// <value>
        /// A <see cref="T:iTin.Export.ComponentModel.AdapterMetadataInformation" /> that contains the extended information about this adapter.
        /// </value>
        public AdapterMetadata MetadataInformation => _metadataInformation;
        #endregion
        ...
        #region [public] (void) SetInputDataModel(InputDataModel): Add a data model to this target
        /// <inheritdoc />
        /// <summary>
