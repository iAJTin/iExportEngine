...
namespace iTin.Export.ComponentModel.Inputs
{
    ...
    public abstract class BaseInput : IInput
    {
        ...
        #region [public] (InputOptionsMetadata) MetadataInformation: Gets a reference that contains the metadata information about this input
        /// <inheritdoc />
        /// <summary>
        ...
        /// </value>
        public InputOptionsMetadata MetadataInformation => _optionsMetadataInformation;
        #endregion
        ...
        public void Export(ExportSettings settings)
        {
            ...
            AdaptersCache adapters = AdaptersCache.Instance(this);
            IAdapter adapter = adapters.GetAdapter(MetadataInformation);
            InputDataModel inputDataModel = new InputDataModel { Model = model, Resources = root.Resources, References = root.References };
            adapter.SetInputDataModel(inputDataModel);
