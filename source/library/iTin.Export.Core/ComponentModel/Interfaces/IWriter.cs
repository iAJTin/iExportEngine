...
namespace iTin.Export.ComponentModel
{
    ...
    public interface IWriter : IDisposable
    {
        ...
        /// <summary>
        /// Gets a reference to an object <see cref="T:iTin.Export.Web.HttpResponseInfo" /> containing the <strong>MIME</strong> type of the output stream and response header for a <strong>ASP.NET</strong> operation.
        /// </summary>
        /// <value>
        /// <see cref="T:iTin.Export.Web.HttpResponseInfo" /> containing the <strong>MIME</strong> type of the output stream and response header for a <strong>ASP.NET</strong> operation.
        /// </value>
        HttpResponseInfo ResponseInfo { get; }
