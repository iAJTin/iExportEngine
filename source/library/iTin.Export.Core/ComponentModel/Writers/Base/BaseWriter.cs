...
namespace iTin.Export.ComponentModel.Writers
{
    ...
    public abstract class BaseWriter : IWriter
    {
        ...
        #region [public] (InputDataModel) Input: Gets a reference to the current data model
        /// <inheritdoc />
        /// <summary>
        ...
        /// </value>
        public InputDataModel Input => Adapter.Input;
        #endregion
        ...
        /// </value>
        public GlobalResourcesModel ModelResources => Input.Resources;
        #endregion
        ...
        /// </value>
        public TableModel Table => Input.Model.Table;
        #endregion
        ...
        public virtual HttpResponseEx ResponseEx
        {
            get
            {
                var filename = Adapter.Input.Model.Table.Output.File;
        ...
        public void Generate(ExportSettings settings)
        {
            ...
            Adapter.Input.Model.Table.Exporter.Behaviors.Execute(this, settings);
        }
        #endregion
        ...
        protected virtual object GetValueByReflection(string value)
        {
            ...
            foreach (var reference in references)
            {
                ...
                var qualifiedAssemblyPathParsed = Input.Model.ParseRelativeFilePath(qualifiedAssemblyPath);
        ...
        {                
            var outputFullPath = Adapter.Input.Model.ParseRelativeFilePath(KnownRelativeFilePath.Output);
        ...
        {
            var transformBehavior = Adapter.Input.Model.Table.Exporter.Behaviors.Get<TransformFileBehaviorModel>();
