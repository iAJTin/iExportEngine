...
namespace iTin.Export.ComponentModel.Writers
{
    ...
    /// <summary>
    /// A Specialization of <see cref="T:iTin.Export.ComponentModel.Writers.BaseWriter" /> Class, than implements interface <see cref="T:iTin.Export.ComponentModel.Writers.IWriterXml" />.
    ...
    public abstract class BaseWriterXml : BaseWriter, IWriterXml
    {
        ...
        /// </summary>
        /// <value>
        /// Always returns ​the <see cref="F:iTin.Export.ComponentModel.KnownWriterIdentifier.WriterXml" /> value.
        /// </value>
        ...
        private void CreateWriter(Stream stream)
        {
            ...
            try
            {
                ...
                YesNo indented;
                var behaviors = Adapter.Input.Model.Table.Exporter.Behaviors;
