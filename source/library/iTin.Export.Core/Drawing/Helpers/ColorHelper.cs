...
namespace iTin.Export.Drawing.Helper
{
    ...
    public static class ColorHelper
    {
        ...
        /// </remarks>
        /// <example>
        /// The following code example, we obtain four different ways the same color, the color <see cref="P:System.Drawing.Color.Black"/>.
        /// <code lang="cs">
        ///   using System;   
        ///   using System.Drawing;
        /// 
        ...
        /// 
        ///            // From hexadecimal.
        ///            Color fromHexString = ColorHelper.GetColorFromString("#000");
        /// 
        ///            // From space color.
        ...
        public static Color GetColorFromString(string value)
        {
            ...
            if (isHexColor)
            {
                var isFull = value.Trim().Length == 7;
                if (isFull)
                {
