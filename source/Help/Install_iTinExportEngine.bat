...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /mediaBookList "iTinExportEngine" /productName "iTinExportEngine" > NUL
...
COPY /Y "iTinExportEngine.msha" HelpContentSetup.msha
